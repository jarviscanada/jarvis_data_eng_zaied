...
public class ArrayJLists<E> extends AbstractList<E> implements JList<E> {
   ...
   * capacity increased by 50% if that suffices. Will not return a capacity greater than
   * MAX_ARRAY_SIZE unless the given minimum capacity is greater than MAX_ARRAY_SIZE.
   *
  ...
  /**
   * This helper method split out from add(E) to keep method bytecode size under 35 (the
   * -XX:MaxInlineSize default value), which helps when add(E) is called in a C1-compiled loop.
   */
